<section class="">
    <div class="filters flex flex-col md:flex-row space-y-3 md:space-y-0 md:space-x-6">
        <div class="w-full md:w-2/3 relative">
            ...
            <input wire:model="search" type="search" placeholder="search discussions here"
                class="text-sm w-full rounded bg-white border-none placeholder-gray-900 px-4 py-2 pl-8">
    ...
    <article class="mt-6 hidden">
        @foreach ([1,2,3] as $i)
            <div class="rounded p-4">
                <h6 class="text-base font-bold tracking-wider inline-flex">Lorem ipsum dolor sit amet.</h6>
