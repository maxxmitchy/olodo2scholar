<footer class="bg-gray-700 text-white p-4 md:p-8">

    <section class="bg-gray-50 rounded">
        <div class="p-8 md:p-12 lg:px-16 lg:py-24">
            ...
            <div class="mx-auto mt-8 max-w-xl">
                <form wire:submit.prevent="store" method="POST" class="sm:flex sm:gap-4">
                    <div class="sm:flex-1">
                    ...
                    <button type="submit"
                        class="group mt-4 flex w-full items-center justify-center rounded-md bg-indigo-600 px-5 py-3 text-white transition focus:outline-none focus:ring focus:ring-yellow-400 sm:mt-0 sm:w-auto">
