        ...
        <article class="bg-gray-50 lg:py-12 lg:px-28 px-5 py-5">
            ...
            <form class="mt-6" method="POST" wire:submit.prevent="store">
                ...
                <div class="mt-4">
                    ...
                    <x-text-input placeholder="enter last name" id="last_name" class="block mt-1 w-full" wire:model.defer="last_name"
                    type="text" name="last_name" :value="old('last_name')" autocomplete="last_name"
                    required />
                ...
                <div class="flex my-8">
                    <label for="terms" class="flex items-center">
                        ...
                        <span class="ml-2 text-xs sm:text-sm tracking-wider">{{__('Agree to our terms of use and privacy.')}}</span>
                    </label>
                </div>

                <button wire:loading class="mt-5 bg-purple-700 py-2 text-base font-semibold text-white
                ...
                <section class="space-y-3">
                    @foreach ( [
                        ...
                        <div @click="current_plan = {{$subscr['id']}}"
                            ...
                            <h6 class="tracking-wider text-sm font-medium">{{ $subscr['name'] }} ${{ $subscr['price'] }}</h6>
                        </div>
                    @endforeach
