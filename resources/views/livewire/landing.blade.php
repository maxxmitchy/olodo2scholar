...
<section class="relative" x-data="{
    ...
    <section class="relative bg-gray-background pb-10">
        ...
        <div class="flex space-x-5 px-5 lg:px-28">
            <a wire:click="$set('status', 'featured')" href="#featured" class="tracking-tight text-sm lg:text-lg font-semibold py-3
            border-b-2 {{ $this->status === 'featured' ? 'border-purple-500' : 'border-transparent' }}">
            Featured
            </a>
            <a wire:click="$set('status', 'recent')" href="#recent" class="tracking-tight text-sm lg:text-lg font-semibold py-3
            border-b-2 {{ $this->status === 'recent' ? 'border-purple-500' : 'border-transparent' }}">
            Recently added
            </a>
            <a wire:click="$set('status', 'trending')" href="#trending" class="tracking-tight text-sm lg:text-lg font-semibold py-3
...
@empty
    <article class="col-span-4 space-x-2 flex justify-center items-center text-red bg-white p-3 rouned">
        <x-Icons.caution class="h-7 w-7 flex-shrink-0"/>
        <p class="tracking-tight">
            We're sorry, but it looks like we don't have any courses that match your search criteria.
            Please try adjusting your search terms or filters to see if we have any courses that might be a good fit for you.
        </p>
    </article>
@endforelse
</section>
        ...
        <div class="mt-20 grid lg:grid-cols-3 lg:gap-20 gap-10 grid-cols-1 max-w-5xl mx-auto">
            <div class="space-y-3 p-5">
                <div class="flex justify-betweeen">
                    ...
                    <h4 class="tracking-tight text-2xl font-semibold">₦1,400</h4>
                </div>
            ...
            <div class="rounded space-y-3 p-5 bg-purple-700 text-white">
                <div class="flex justify-betweeen">
                    ...
                    <h4 class="tracking-tight text-2xl font-semibold">₦4,000</h4>
                </div>
            ...
            <div class="rounded space-y-3 p-5 bg-purple-700 text-white">
                <div class="flex justify-betweeen">
                    ...
                    <h4 class="tracking-tight text-2xl font-semibold">₦7,500</h4>
                </div>
    ...
    <div class="mt-20 grid lg:grid-cols-3 gap-10 grid-cols-1 max-w-5xl mx-auto">
        @foreach ($testimonials = [  ["author" => "John Ideh",    "text" => "I absolutely love using this platform! The questions were challenging but helped me retain the information better. I highly recommend giving it a try."  ],
                ["author" => "Ibeh Ameachi", "text" => "This platform was a game-changer for me.
        ...
        <div class="space-y-3">
            ...
            <div class="h-10 w-10 flex justify-center items-center p-2  font-black flex-shrink-0 text-white bg-black rounded-full shadow">{{showInitials($i['author'])}}</div>
