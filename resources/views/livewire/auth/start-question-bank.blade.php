<section x-data="{
    ...
    <div class="mx-auto max-w-3xl" x-data="{
        ...
        <div class="bg-indigo-600 py-3 px-5 inset-x-0 fixed w-full flex justify-between">
        ...
        <section class="pt-[155px] px-5 overflow-y-scroll h-2/3 mb-20" :class="{ 'blur-sm': interval == null }">
        ...
        <div class="bg-indigo-600 py-3 px-5 fixed inset-x-0 bottom-0 w-full flex items-center justify-between">
            <div class="flex space-y-1 flex-col">
                ...
                <p class="tracking-wider text-sm font-bold text-white underline">
                    00:{{ $minutes }}:{{ $seconds }}</p>
            </div>
