            ...
            <div class="w-full mx-2 md:mx-4">
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                    ...
                    <div
                        ...
                        x-data="{ isOpen: false }"
                    >
                        <div class="{{ 'status-'.Str::kebab($idea->status->name) }} text-xxs font-bold uppercase leading-none rounded text-center w-28 h-7 py-2 px-4">{{ $idea->status->name }}</div>
                        @auth
                        <div class="relative">
                            <button
                            ...
                            <ul
                                class="absolute w-44 text-left font-semibold bg-white shadow-dialog rounded z-10 py-3 md:ml-8 top-8 md:top-6 right-0 md:left-0"
                                x-cloak
        ...
        <div class="hidden md:flex items-center space-x-3">
            ...
            @if ($hasVoted)
                <button
                    type="button"
                    wire:click.prevent="vote"
                    class="w-32 h-11 text-xs bg-purplee text-white font-semibold uppercase rounded border border-purplee hover:bg-purplee-hover transition duration-150 ease-in px-6 py-3"
                >
                    <span>Voted</span>
                </button>
            @else
