<div x-data="{ isOpen: false }" class="relative">
    ...
    <ul class="absolute w-76 md:w-96 text-left text-gray-700 text-sm bg-white shadow-dialog rounded max-h-128 overflow-y-auto z-10 -right-28 md:-right-12"
            ...
            @foreach ($notifications as $notification)
                <li>
                    ...
                    "
                        ...
                        <img src="{{ $notification->data['user_avatar'] }}" class="rounded w-10 h-10" alt="avatar">
                        <div class="ml-4">
        ...
        @elseif ($isLoading)
            @foreach (range(1, 3) as $item)
                <li class="animate-pulse flex items-center transition duration-150 ease-in px-5 py-3">
                    <div class="bg-gray-200 rounded w-10 h-10"></div>
